...
urlpatterns = [
    ...
    path("token/", MyTokenObtainPairView.as_view(), name=TOKEN_OBTAIN_PAIR_URL_NAME),
    path("token/refresh/", MyTokenRefreshView.as_view(), name=TOKEN_REFRESH_URL_NAME),
    path("token/verify/", MyTokenVerifyView.as_view(), name=TOKEN_VERIFY_URL_NAME),
